...
$jscomp.makeIterator=function(c){$jscomp.initSymbolIterator();if(c[$jscomp.global.Symbol.iterator])return c[$jscomp.global.Symbol.iterator]();if(!(c instanceof Array||"string"==typeof c||c instanceof String))throw new TypeError(c+" is not iterable");var f=0;return{next:function(){return f==c.length?{done:!0}:{done:!1,value:c[f++]}}}};$jscomp.arrayFromIterator=function(c){for(var f,h=[];!(f=c.next()).done;)h.push(f.value);return h};
$jscomp.arrayFromIterable=function(c){return c instanceof Array?c:$jscomp.arrayFromIterator($jscomp.makeIterator(c))};$jscomp.arrayFromArguments=function(c){for(var f=[],h=0;h<c.length;h++)f.push(c[h]);return f};
$jscomp.inherits=function(c,f){function h(){}h.prototype=f.prototype;c.prototype=new h;c.prototype.constructor=c;for(var m in f)if($jscomp.global.Object.defineProperties){var k=$jscomp.global.Object.getOwnPropertyDescriptor(f,m);void 0!==k&&$jscomp.global.Object.defineProperty(c,m,k)}else c[m]=f[m]};
"function"!=typeof Object.assign&&function(){Object.assign=function(c){if(void 0===c||null===c)throw new TypeError("Cannot convert undefined or null to object");for(var f=Object(c),h=1;h<arguments.length;h++){var m=arguments[h];if(void 0!==m&&null!==m)for(var k in m)m.hasOwnProperty(k)&&(f[k]=m[k])}return f}}();
(function(c,f,h,m,k,n,E,F){k(function(){function G(b){var a=b.getContext("2d");a.lineCap="round";a.lineWidth=3*z;var g=[],l=!1,A=!1,e=!1,d=c.requestAnimationFrame,f=function(b){A=!0;e||(g.push(g[0]),a.moveTo.apply(a,g[0]),a.beginPath(),e=!0);b&&g.concat(g.slice(-1));if(4>g.length){if(!b)return;l||(a.arc(g[0][0],g[0][1],a.lineWidth,0,2*Math.PI),a.fill())}else for(var c=0;c<g.length-4+1;++c){var d=g.slice(c,c+4);a.lineTo.apply(a,d[1]);for(var f=1;8>f;++f){var h=f/8;a.lineTo.apply(a,k.map([0,1],function(b){return.5*
(2*d[1][b]+(-d[0][b]+d[2][b])*h+(2*d[0][b]-5*d[1][b]+4*d[2][b]-d[3][b])*h*h+(-d[0][b]+3*d[1][b]-3*d[2][b]+d[3][b])*h*h*h)}))}a.lineTo.apply(a,d[2])}a.stroke();a.beginPath();l=!0;b?(a.closePath(),g=[],l=e=!1):g=g.slice(-3)};return{clear:function(){a.clearRect(0,0,b.width,b.height);g=[];A=l=e=!1},hasDrawn:function(){return A},destroyEventListeners:function(){k(b).off("touchstart");k(b).off("touchmove");k(b).off("touchend")},setupEventListeners:function(){var a=+k(b).offset().left,l=+k(b).offset().top,
c=k(b).attr("width")/+k(b).width(),D=function(b){g.push([(+b.originalEvent.touches[0].pageX-a)*c,(+b.originalEvent.touches[0].pageY-l)*c])};k(b).off("touchstart").on("touchstart",function(b){d(function(){D(b);f(!1)});return!1});k(b).off("touchmove").on("touchmove",function(b){d(function(){D(b);f(!1)});return!1});k(b).off("touchend").on("touchend",function(b){d(function(){f(!0)});return!1})}}}var H=Date.now(),a=h.createElement,d=h.Component,e=h.PropTypes,z=c.devicePixelRatio||1,I=function(b,a){var g=
Math.min(b.length,a.length),l=function(c){return c===g?c:b.charCodeAt(c)===a.charCodeAt(c)?l(1+c):c};return l(0)},J=function(){var b=new Date,a=b.getDate(),c=b.getMonth(),b=b.getFullYear();return a+" "+"January February March April May June July August September October November December".split(" ")[c]+", "+b},K=n.Record({type:"unspecified",timeStamp:0,keyCode:0,targetValue:""}),r=function(b){d.call(this,b);this.displayName="TrackingTextarea"};$jscomp.inherits(r,d);r.prototype.focus=function(){this.refs.b.focus()};
r.prototype.render=function(){var b=this,c=function(b){b.stopPropagation();b.preventDefault()},g=function(a){a=new K({type:a.type,timeStamp:a.timeStamp,keyCode:a.keyCode,targetValue:a.target.value});b.props.onNewKeyEvent(a)};return a(this.props.useInputInstead?"input":"textarea",Object.assign({onCopy:c,onCut:c,onPaste:c,onKeyDown:g,onKeyUp:g,autoComplete:"off",className:"form-control",style:this.props.resizable?{}:{resize:"none"}},this.props.otherAttributes,{ref:"b"}))};r.propTypes={onNewKeyEvent:e.func.isRequired,
otherAttributes:e.object,resizable:e.bool,useInputInstead:e.bool};var p=function(b){h.Component.call(this,b);this.displayName="VerbatimTyping";this.state={value:"",highlightRange:0,validationState:"",helpText:this.formatDefaultHelpText(b.typeText)}};$jscomp.inherits(p,h.Component);p.prototype.shouldComponentUpdate=function(b,a){return!(a.value===this.state.value&&a.highlightRange===this.state.highlightRange&&a.helpText===this.state.helpText)};p.prototype.formatDefaultHelpText=function(b){b=b.split(/\s/).length;
...
if(b.props.onRetry)b.props.onRetry()}},onChange:function(a){var c=a.target.value;b.setState({value:c});a=b.props.typeText;var l=I(a.toLowerCase(),c.toLowerCase());b.setState({highlightRange:l});c=Math.min(a.length,c.length);l===a.length?b.setState({validationState:"has-success",helpText:"Done!"}):l===c?b.setState({validationState:"",helpText:b.formatDefaultHelpText(b.props.typeText.slice(c))}):l<c&&b.setState({validationState:"has-error",helpText:"There is a mistake there\u2026 Please follow the given text closely."})},
onFocus:function(){b.props.typeText&&"has-success"!==b.state.validationState&&b.setState({helpText:b.formatDefaultHelpText(b.props.typeText)})},readOnly:"has-success"===this.state.validationState},ref:"b",onNewKeyEvent:this.props.onNewKeyEvent}),this.state.helpText?a("p",{className:"help-block"},this.state.helpText):null)};p.propTypes={rows:e.number,labelText:e.string.isRequired,typeText:e.string.isRequired,onNewKeyEvent:e.func.isRequired,onRetry:e.func};var L=function(b){for(var c=[],g=0;g<arguments.length;++g)c[g-
0]=arguments[g];return a("div",{className:"row"},a.apply(null,[].concat(["div",{className:"col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2"}],$jscomp.arrayFromIterable(c))))},q=function(b){d.call(this,b);this.displayName="GenericPage"};$jscomp.inherits(q,d);q.prototype.render=function(){return a("div",{},this.props.preTitleContent||a("div",{}),L(a("h1",{className:"text-center"},this.props.title),a("div",{className:"text-center"},this.props.explanation)),this.props.content)};q.propTypes={preTitleContent:e.node,
title:e.node.isRequired,explanation:e.node.isRequired,content:e.node.isRequired};var v=function(b){d.call(this,b);this.displayName="Page0Welcome"};$jscomp.inherits(v,d);v.prototype.render=function(){return void 0===f.ontouchmove?a(q,{title:"Device Unsupported",explanation:a("div",{},a("p",{},"Welcome to River Valley High School Science Lab Undertaking Declaration Site. You will need to perform a signature, therefore to use this website, you need a touchscreen. Your device and/or your browser does not support touch."),
a("p",{},"If you are a teacher, please ",a("a",{href:"/admin"},"log in and visit the administrator console"),"."))}):a(q,{preTitleContent:a("div",{className:"row",style:{padding:"30px 0"}},a("img",{className:"center-block img-responsive",width:200,src:"/static/res/rvcrayon.jpg"})),title:"RVHS Science Lab Undertaking",explanation:a("div",{},a("p",{},"Welcome!"),a("p",{},"In this exericse, you will verify and provide essential personal information. At the same time, you will undertake to agree to the Science Laboratory Rules and endorse your declaration."),
a("p",{},"If you have a Personal Learning Device (PLD) with a large screen (tablets instead of phones), it is ",a("strong",{},"highly recommended")," that you use such a device to proceed due to the convenience afforded by the larger screen.")),content:a("div",{},a("div",{className:"row",style:{padding:"30px 0"}},a("p",{className:"text-center"},a("button",{className:"btn btn-primary",onClick:this.props.onContinueClick},"Continue"))))})};v.propTypes={onContinueClick:e.func.isRequired};var u=function(b){d.call(this,
b);this.displayName="ListPickerPage"};$jscomp.inherits(u,d);u.prototype.render=function(){var b=this;return a(q,{title:this.props.title,explanation:this.props.explanation,content:a("ul",{className:"list-group"},this.props.data.map(function(c,g){return a("li",{key:g,className:"list-group-item",style:{position:"relative"},onClick:function(){b.props.onClick(c)}},b.props.dataFormatter(c),a("span",{className:"glyphicon glyphicon-chevron-right",style:{position:"absolute",display:"block",right:10,top:"50%",
transform:"translateY(-50%)",MsTransform:"translateY(-50%)",WebkitTransform:"translateY(-50%)"}}))}))})};u.propTypes={title:e.node.isRequired,explanation:e.node.isRequired,data:e.object.isRequired,onClick:e.func.isRequired,dataFormatter:e.func.isRequired};var w=function(b){d.call(this,b);this.displayName="Page1ClassChooser"};$jscomp.inherits(w,d);w.prototype.render=function(){return a(u,{title:"Choose Your Class",explanation:a("div",{},a("p",{},"Choose your class from the list below."),a("p",{},"If you cannot find your class, please seek assistance from your science teacher.")),
onClick:this.props.onClassClick,data:this.props.classes,dataFormatter:function(b){return b}})};w.propTypes={onClassClick:e.func.isRequired,classes:e.object.isRequired};var x=function(b){d.call(this,b);this.displayName="Page2StudentChooser"};$jscomp.inherits(x,d);x.prototype.render=function(){return a(u,{title:"Choose Your Name",explanation:a("div",{},a("p",{},"Choose your name from this list below to access your personal information."),a("p",{},"If you cannot find your name, please seek assistance from your science teacher.")),
onClick:this.props.onStudentClick,data:this.props.students,dataFormatter:function(b){return b.first()+". "+b.last()}})};x.propTypes={onStudentClick:e.func.isRequired,students:e.object.isRequired};var y=function(b){d.call(this,b);this.displayName="Page3AskForNric";this.state={partialNric:""}};$jscomp.inherits(y,d);y.prototype.render=function(){var b=this;return a(q,{title:"Authentication",explanation:a("p",{},"In order to verify your identity, enter the ",a("strong",{},"LAST FOUR")," characters of your NRIC / FIN, e.g. for S9876",
...
b.setState({phone:c[0],phoneValidationState:"has-success"}):a()}},resizable:!1}))),n.List.of(1,2,3).map(function(d){return a("div",{className:"form-group",key:d},a("label",{className:"col-sm-4 control-label",htmlFor:"cca"+d},"CCA / Academy / Others "+d),a("div",{className:"col-sm-8"},a("select",{className:"form-control",id:"cca"+d,onChange:c(d)},b.props.ccas.groupBy(function(a){return a.get("category")}).map(function(b,c){return b.map(function(b){return a("option",{value:b.get("id"),key:b.get("id")},
...
if(5===b.state.currentPage)return a(t,{onSubmitClick:function(a){console.log("Page 5: submit click");a=n.fromJS({nric:b.state.currentStudentNric,email:b.state.currentStudentEmail,phone:b.state.currentStudentPhone,cca1:b.state.currentStudentCca1,cca2:b.state.currentStudentCca2,cca3:b.state.currentStudentCca3,sig:a,ua:c.navigator.userAgent}).map(function(a,b){return b+"="+c.encodeURIComponent(a).replace("%20","+")}).toList().join("&");console.log(a);var d=JSON.stringify({recordedEvents:b.state.recordedEvents,
userAgent:c.navigator.userAgent,mediaWidth:Math.max(f.documentElement.clientWidth,c.innerWidth||0),mediaHeight:Math.max(f.documentElement.clientHeight,c.innerHeight||0),screenWidth:c.screen.width,screenHeight:c.screen.height,devicePixelRatio:c.devicePixelRatio||1,pageLoadTime:H,pageSubmitTime:Date.now(),performanceNow:c.performance&&c.performance.now?c.performance.now():null});console.log(d);var e=E.fromByteArray(F.deflate(d));console.log(e);k.post("/api/students/"+b.state.currentStudentId+"/submit",
a,function(){k.post("https://rvhs-kd-research.appspot.com/submit",e,function(){b.setState({currentPage:6})})})},studentName:b.state.currentStudent.last(),onNewKeyEventGen:d,onRetryGen:e});if(6===b.state.currentPage)return a(C,{});throw"Internal error.";}())};m.render(a(e,{}),f.getElementById("body"))})})(window,document,React,ReactDOM,$,Immutable,base64js,pako);
