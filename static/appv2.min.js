...
$jscomp.makeIterator=function(c){$jscomp.initSymbolIterator();if(c[$jscomp.global.Symbol.iterator])return c[$jscomp.global.Symbol.iterator]();if(!(c instanceof Array||"string"==typeof c||c instanceof String))throw new TypeError(c+" is not iterable");var h=0;return{next:function(){return h==c.length?{done:!0}:{done:!1,value:c[h++]}}}};$jscomp.arrayFromIterator=function(c){for(var h,g=[];!(h=c.next()).done;)g.push(h.value);return g};
$jscomp.arrayFromIterable=function(c){return c instanceof Array?c:$jscomp.arrayFromIterator($jscomp.makeIterator(c))};$jscomp.arrayFromArguments=function(c){for(var h=[],g=0;g<c.length;g++)h.push(c[g]);return h};
$jscomp.inherits=function(c,h){function g(){}g.prototype=h.prototype;c.prototype=new g;c.prototype.constructor=c;for(var m in h)if($jscomp.global.Object.defineProperties){var k=$jscomp.global.Object.getOwnPropertyDescriptor(h,m);void 0!==k&&$jscomp.global.Object.defineProperty(c,m,k)}else c[m]=h[m]};
"function"!=typeof Object.assign&&function(){Object.assign=function(c){if(void 0===c||null===c)throw new TypeError("Cannot convert undefined or null to object");for(var h=Object(c),g=1;g<arguments.length;g++){var m=arguments[g];if(void 0!==m&&null!==m)for(var k in m)m.hasOwnProperty(k)&&(h[k]=m[k])}return h}}();
(function(c,h,g,m,k,n){k(function(){function E(b){var a=b.getContext("2d");a.lineCap="round";a.lineWidth=3*z;var e=[],l=!1,A=!1,f=!1,d=c.requestAnimationFrame,g=function(b){A=!0;f||(e.push(e[0]),a.moveTo.apply(a,e[0]),a.beginPath(),f=!0);b&&e.concat(e.slice(-1));if(4>e.length){if(!b)return;l||(a.arc(e[0][0],e[0][1],a.lineWidth,0,2*Math.PI),a.fill())}else for(var c=0;c<e.length-4+1;++c){var d=e.slice(c,c+4);a.lineTo.apply(a,d[1]);for(var g=1;8>g;++g){var h=g/8;a.lineTo.apply(a,k.map([0,1],function(b){return.5*
...
content:f.node.isRequired};var v=function(b){d.call(this,b);this.displayName="Page0Welcome"};$jscomp.inherits(v,d);v.prototype.render=function(){return a(q,{preTitleContent:a("div",{className:"row",style:{padding:"30px 0"}},a("img",{className:"center-block img-responsive",width:200,src:"/static/res/rvcrayon.jpg"})),title:"RVHS Science Lab Undertaking",explanation:a("div",{},a("p",{},"Welcome!"),a("p",{},"In this exericse, you will verify and provide essential personal information. At the same time, you will undertake to agree to the Science Laboratory Rules and endorse your declaration."),
...
"/submit",a,function(){b.setState({currentPage:6})})},studentName:b.state.currentStudent.last(),onNewKeyEventGen:d,onRetryGen:e});if(6===b.state.currentPage)return a(C,{});throw"Internal error.";}())};m.render(a(f,{}),h.getElementById("body"))})})(window,document,React,ReactDOM,$,Immutable);
