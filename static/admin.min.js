...
(function(f,n,p,q,m,d){m(function(){var a=p.createElement,l=p.createClass,B=p.Component,e=p.PropTypes,k=d.map,K=m("#meta-user").attr("value"),u=function(){var a=m("#meta-priv").attr("value");return"PrivAdmin"===a||"PrivOperator"===a}(),C=function(a){var c=("https:"===f.location.protocol?"wss://":"ws://")+f.location.host+a,g=null,h=null,d=null,e=function(){2E3<Date.now()-d?(d=Date.now(),g=new f.WebSocket(c),g.onmessage=h,g.onerror=function(){console.log("APIConnectionWS: conn.onerror");e()},g.onclose=
function(a){console.log("APIConnectionWS: conn.onclose");console.log(a);e()}):f.setTimeout(e,Date.now()-d)};return{registerCallback:function(a){g||e();var b=function(b){return a(JSON.parse(b.data))};h=g.onmessage=b},pathname:function(){return a},close:function(){g.onmessage=function(){};g.onerror=function(){};g.onclose=function(){};h=null;g.close()}}},D=function(a){var c="//"+f.location.host+a,g=null,h=null,d=function(){g=new f.EventSource(c);g.onmessage=h;g.onerror=function(){console.log("APIConnectionSSE: "+
a+": conn.onerror")};g.onclose=function(){console.log("APIConnectionSSE: "+a+": conn.onclose")}};return{registerCallback:function(a){g||d();var b=function(b){return a(JSON.parse(b.data))};h=g.onmessage=b},pathname:function(){return a},close:function(){h=null;g.close()}}},E=function(a){var c="//"+f.location.host+a,g=null,h=null,d=function(){m.ajax({url:c,success:function(a){g&&g(a);h=f.setTimeout(d,3E3)}})};d();return{registerCallback:function(a){g=a},pathname:function(){return a},close:function(){h&&
f.clearTimeout(h);h=null}}},v=f.EventSource?D:f.WebSocket?C:E,I=l(d.defaults({propTypes:{firstRowSpan:e.number.isRequired,entity:e.object.isRequired,entityEditor:e.any.isRequired,auxiliary:e.object},render:function(){var b=this,c=t[f.location.pathname].dataSpec,g=null!==c.categoryColumn&&b.props.firstRowSpan?a("td",{rowSpan:b.props.firstRowSpan},c.categoryColumn[1].apply(b.props.auxiliary,[b.props.entity[c.categoryColumn[0]],b.props.entity])):null,h=function(){return q.render(a(b.props.entityEditor,
{auxiliary:b.props.auxiliary,entity:b.props.entity}),r())},d=function(){return q.render(a(L,{auxiliary:b.props.auxiliary,entity:b.props.entity}),r())};return a("tr",{},g,k(c.columns,function(c,g){return a("td",{key:g},c[1].apply(b.props.auxiliary,[b.props.entity[c[0]],b.props.entity]))}),u?a("td",{className:"text-right"},a("div",{className:"btn-group",role:"group"},a("button",{type:"button",className:"btn btn-default btn-xs",title:"Edit",onClick:h},a("span",{className:"glyphicon glyphicon-pencil",
...
{className:"alert alert-danger",role:"alert"},this.state.err):null,this.props.children)}},{render:function(){return!1}},d.invert({AjaxFailableActionModal:"displayName"}))),y=l(d.defaults({propTypes:{entityTypeHumanName:e.string.isRequired,entityTypeMachineName:e.string.isRequired,entity:e.object,children:e.node.isRequired},getInitialState:function(){return{err:null}},render:function(){var b=this.props.entityTypeHumanName,c=this.props.entityTypeMachineName,g=this.props.entity?"/api/"+c+"/"+this.props.entity.id:
"/api/"+c,h=this.props.entity?"PUT":"POST";return a("form",{id:"editorForm",role:"form"},a(x,{title:this.props.entity?"Edit "+b:"Add a new "+b,actionButtonLabel:this.props.entity?"Edit":"Add",actionButtonStyle:"primary",actionButtonType:"submit",ajaxParam:function(){return{url:g,type:h,data:m("#editorForm").serialize()}}},this.props.children))}},{render:function(){return!1}},d.invert({RecordEditor:"displayName"}))),C=l(d.defaults({propTypes:{entity:e.object},render:function(){return a(y,{entity:this.props.entity,
...
{render:function(){return!1}},d.invert({SubjectEditor:"displayName"}))),H=function(a){B.call(this,a);this.displayName="BatchUpload"};$jscomp.inherits(H,B);H.prototype.render=function(){var b=this,c=t[f.location.pathname].dataSpec;return a(x,{actionButtonStyle:"primary",actionButtonLabel:"Upload",title:"Add "+c.humanNamePlural+" via Uploading CSV/TSV/TXT File",ajaxParam:function(){return{url:"/api/"+c.machineName+"/csv",type:"POST",data:new f.FormData(b.refs.uploaderForm),contentType:!1,processData:!1}}},
...
z=l(d.defaults({propTypes:{customButtons:e.node,wsUrl:e.string,auxiliary:e.object,customFilter:e.func},getInitialState:function(){var a=t[f.location.pathname].dataSpec.machineName;return{conn:v(this.props.wsUrl||"/api/"+a)}},componentWillReceiveProps:function(a){a.wsUrl!==this.props.wsUrl?(this.state.conn.close(),a=this.setState({conn:v(a.wsUrl)})):a=void 0;return a},render:function(){var b=this,c=t[f.location.pathname].dataSpec,d=c.humanNamePlural,h=c.machineName,e=c.editor,c=function(){return q.render(a(e,
{auxiliary:b.props.auxiliary}),r())},k=function(){return q.render(a(x,{title:"Deleting All "+d,actionButtonLabel:"Yes, Delete All",actionButtonStyle:"danger",ajaxParam:function(){return{url:"/api/"+h,type:"DELETE"}}},a("p",{},"Are you sure you want to delete all ",d," currently stored in the database? ")),r())};return a("div",{},u?a("div",{className:"pull-right btn-group",role:"toolbar","aria-label":"Action Buttons"},this.props.customButtons?this.props.customButtons:null,a("button",{type:"button",
className:"btn btn-default",onClick:function(){return q.render(a(H,{}),r())}},"Add New (CSV/TSV/TXT File)"),a("button",{type:"button",className:"btn btn-default",onClick:c},"Add New"),a("button",{type:"button",className:"btn btn-default",onClick:k},"Remove All (Even If Not Shown)")):null,a("h2",{},"View "+d),this.props.children,a(N,{conn:this.state.conn,entityEditor:e,auxiliary:this.props.auxiliary,customFilter:this.props.customFilter}))},shouldComponentUpdate:function(a){return!d.isEqual(this.props,
a)}},{render:function(){return!1}},d.invert({EntityPage:"displayName"}))),R=l(d.defaults({render:function(){return a(z,{})}},{render:function(){return!1}},d.invert({AdminCcasR:"displayName"}))),S=l(d.defaults({render:function(){var b=a("button",{onClick:function(){return q.render(a(O,{}),r())},type:"button",className:"btn btn-default"},"Test Decode");return a(z,{customButtons:b})}},{render:function(){return!1}},d.invert({AdminSubjectsR:"displayName"}))),T=l(d.defaults({render:function(){return a(z,
{})}},{render:function(){return!1}},d.invert({AdminTeachersR:"displayName"}))),w=function(a){var c=this;a=v("/api/ccas");var d=v("/api/teachers"),h=v("/api/subjects"),e=v("/api/classes");a.registerCallback(function(a){c.setState({ccaInfo:a});c.reserializeForm()});d.registerCallback(function(a){c.setState({teacherInfo:a});c.reserializeForm()});h.registerCallback(function(a){c.setState({subjectInfo:a});c.reserializeForm()});e.registerCallback(function(a){c.setState({classInfo:a});c.reserializeForm()});
e={data:[]};this.state={queryString:"searchby=none",selected:"class",hideWithoutWitness:!0,ccaConn:a,teacherConn:d,subjectConn:h,ccaInfo:e,teacherInfo:e,subjectInfo:e,classInfo:e}};$jscomp.inherits(w,B);w.prototype.reserializeForm=function(){console.log(this);this.setState({queryString:m(this.refs.searchbyForm).serialize()})};w.prototype.componentDidUpdate=function(a,c){c.selected!==this.state.selected&&this.reserializeForm()};w.prototype.componentWillUnmount=function(){this.state.ccaConn.close();
this.state.teacherConn.close();this.state.subjectConn.close();this.state.classConn.close()};w.prototype.render=function(){var b=this,c=function(a){a.target.checked&&b.setState({selected:a.target.value})},e={teacherInfo:this.state.teacherInfo,ccaInfo:this.state.ccaInfo,subjectInfo:this.state.subjectInfo,classInfo:this.state.classInfo};return a("div",{},a("div",{className:"row"},a("h4",{className:"col-sm-offset-3 col-md-offset-3 col-lg-offset-3  col-sm-9 col-md-7 col-lg-6 "},"Which students would you like to see?")),
a("form",{role:"form",ref:"searchbyForm",className:"form-horizontal"},a("div",{className:"radio form-group"},a("label",{className:"col-md-offset-1 col-lg-offset-1 col-sm-3 col-md-2 col-lg-2 control-label"},a("input",{type:"radio",name:"searchby",value:"class",defaultChecked:!0,onChange:c}),"Search By Class"),a("div",{className:"col-sm-9 col-md-7 col-lg-6 "},"class"===this.state.selected?a("select",{className:"form-control",name:"class",onChange:this.reserializeForm.bind(this)},k(e.classInfo.data,
function(b){b=b[0]+b[1];return a("option",{value:b,key:b},b)})):a("select",{className:"form-control",disabled:!0}))),a("div",{className:"radio form-group"},a("label",{className:"col-md-offset-1 col-lg-offset-1 col-sm-3 col-md-2 col-lg-2 control-label"},a("input",{type:"radio",name:"searchby",value:"level",defaultChecked:!1,onChange:c}),"Search By Level"),a("div",{className:"col-sm-9 col-md-7 col-lg-6 "},"level"===this.state.selected?a("select",{className:"form-control",name:"level",onChange:this.reserializeForm.bind(this)},
k(d.uniq(e.classInfo.data,!1,function(a){return a[0]}),function(b){return a("option",{value:b[0],key:b[0]},"Year ",b[0])})):a("select",{className:"form-control",disabled:!0}))),a("div",{className:"radio form-group"},a("label",{className:"col-md-offset-1 col-lg-offset-1 col-sm-3 col-md-2 col-lg-2 control-label"},a("input",{type:"radio",name:"searchby",value:"name",defaultChecked:!1,onChange:c}),"Search By Approx. Name"),a("div",{className:"col-sm-9 col-md-7 col-lg-6 "},"name"===this.state.selected?
a("input",{type:"text",className:"form-control",name:"name",placeholder:"Enter an approximate name, e.g. Xin Yi",onChange:this.reserializeForm.bind(this)}):a("input",{type:"text",className:"form-control",disabled:!0}))),a("div",{className:"radio form-group"},a("label",{className:"col-md-offset-1 col-lg-offset-1 col-sm-3 col-md-2 col-lg-2 control-label"},a("input",{type:"radio",name:"searchby",value:"subject",defaultChecked:!1,onChange:c}),"Search By Subject"),a("div",{className:"col-sm-9 col-md-7 col-lg-6 "},
"subject"===this.state.selected?a("select",{className:"form-control",name:"id",onChange:this.reserializeForm.bind(this)},k(d.sortBy(e.subjectInfo.data,function(a){return a.name}),function(b){return a("option",{value:b.id,key:b.id},b.name," (",k(b.level,function(a){return"Year "+a}).join(", "),")")})):a("select",{className:"form-control",disabled:!0}))),a("div",{className:"radio form-group"},a("label",{className:"col-md-offset-1 col-lg-offset-1 col-sm-3 col-md-2 col-lg-2 control-label"},a("input",
{type:"radio",name:"searchby",value:"cca",defaultChecked:!1,onChange:c}),"Search By CCA"),a("div",{className:"col-sm-9 col-md-7 col-lg-6 "},"cca"===this.state.selected?a("select",{className:"form-control",name:"id",onChange:this.reserializeForm.bind(this)},k(e.ccaInfo.data,function(b){return a("option",{value:b.id,key:b.id},b.name," (",b.category,")")})):a("select",{className:"form-control",disabled:!0}))),a("div",{className:"radio form-group"},a("label",{className:"col-md-offset-1 col-lg-offset-1 col-sm-3 col-md-2 col-lg-2 control-label"},
...
a("div",{className:"checkbox"},a("label",{},a("input",{type:"checkbox",defaultChecked:!0,onChange:function(a){b.setState({hideWithoutWitness:a.target.checked})}})," Hide Students Without Witness"))))),a("div",{className:"row"},a(z,{wsUrl:"/api/students?"+this.state.queryString,auxiliary:e,customFilter:function(a){return b.state.hideWithoutWitness?d.filter(a,function(a){return a.witnesser}):a}})))};var A=function(a,c){return d.find(a.data,function(a){return c===a.id})||"??"},U=l(d.defaults({propTypes:{sub:e.object.isRequired,
ccaInfo:e.object.isRequired,onLockClick:e.func.isRequired,onUnlockClick:e.func.isRequired},render:function(){var b=this,c=a("button",{type:"button",className:"btn btn-default","data-dismiss":"modal"},"OK");return a(F,{canClose:!0,title:"Student-Submitted Information",buttons:c},a("table",{className:"table"},a("tbody",{},a("tr",{},a("th",{},"Email"),a("td",{},this.props.sub.email)),a("tr",{},a("th",{},"Phone Number"),a("td",{},this.props.sub.phone)),a("tr",{},a("th",{},"Date of Submission"),a("td",
{},this.props.sub.date)),a("tr",{},a("th",{},"CCAs"),a("td",{},k(this.props.sub.cca,function(a){return A(b.props.ccaInfo,a).name}).join(", ")||"None")),a("tr",{},a("th",{},"Delete Submission"),a("td",{},a("div",{className:"btn-toolbar",role:"toolbar"},a("button",{type:"button",className:"btn btn-default",onClick:function(){b.props.onUnlockClick();return G()}},"Delete and Unlock"),a("button",{type:"button",className:"btn btn-default",onClick:function(){b.props.onLockClick();return G()}},"Delete and Lock")))))))}},
{render:function(){return!1}},d.invert({SubmissionCompleteModal:"displayName"}))),t={"/admin":{pageName:"Home",onlyAdmin:!1,component:Q,dataSpec:null},"/admin/ccas":{pageName:"Manage CCAs",onlyAdmin:!0,component:R,dataSpec:{humanName:"CCA",humanNamePlural:"CCAs",humanNameInSentence:"CCA",humanNamePluralInSentence:"CCAs",machineName:"ccas",editor:C,categoryColumn:["category",d.identity,"CCA Category"],columns:[["name",d.identity,"CCA Name"]]}},"/admin/subjects":{pageName:"Manage Subjects",onlyAdmin:!0,
component:S,dataSpec:{humanName:"Subject",humanNamePlural:"Subjects",humanNameInSentence:"subject",humanNamePluralInSentence:"subjects",machineName:"subjects",editor:D,categoryColumn:["level",function(a){return k(a,function(a){return"Year "+a}).join(", ")},"Applies To"],columns:[["name",d.identity,"Subject Name"],["code",function(b){return b?a("code",{},b):a("i",{},"(None; Compulsory Subject)")},"Subject Code"],["is_science",function(a){return a?"Yes":"No"},"Science Subject?"]]}},"/admin/teachers":{pageName:"Manage Teachers",
onlyAdmin:!0,component:T,dataSpec:{humanName:"Teacher",humanNamePlural:"Teachers",humanNameInSentence:"teacher",humanNamePluralInSentence:"teachers",machineName:"teachers",editor:E,categoryColumn:null,columns:[["name",d.identity,"Name"],["unit",d.identity,"Unit"],["email",d.identity,"Email Address"],["is_admin",function(a){return a?"Yes":"No"},"Administrator?"],["witness_name",d.identity,"Witness Name"]]}},"/admin/students":{pageName:"Manage Students",onlyAdmin:!1,component:w,dataSpec:{humanName:"Student",
humanNamePlural:"Students",humanNameInSentence:"student",humanNamePluralInSentence:"students",machineName:"students",editor:P,categoryColumn:["class",d.identity,"Class"],columns:[["index_number",d.identity,"Index #"],["name",d.identity,"Name"],["chinese_name",d.identity,"Chinese"],["nric",function(a){return a.slice(-5)},"ID"],["subject_combi",function(b){var c=this,d=k(b,function(a){return A(c.subjectInfo,a).code}).join(", ");b=k(b,function(a){return A(c.subjectInfo,a).name}).join(", ");return d?
a("span",{title:b},d):"\u2014"},"Subject(s)"],["witnesser",function(b){return null===b?a("i",{},"None"):A(this.teacherInfo,b).name},"Witness"],["submission",function(a){return a.email||"\u2014"},"Email"],["submission",function(a){return a.phone||"\u2014"},"Phone"],["submission",function(b){return b.final_declaration_filename?a("a",{className:"btn btn-default btn-xs",target:"_blank",href:"https://rvhs-sci-lab-undertaking.appspot.com/storage?filename="+encodeURIComponent(b.final_declaration_filename)},
...
c,a("span",{className:"presentation-text","data-text":" Lock These"})))}]]}}},l=l(d.defaults({render:function(){var b=f.location.pathname,c=k(t,function(c,d){var e=a("li",{key:d,role:"presentation",className:d===b?"active":""},a("a",{href:d===b?"#":d},c.pageName));return c.onlyAdmin?u?e:null:e});return a("div",{id:"content-wrapper"},a("div",{id:"popover-wrapper"}),a("div",{id:"modal-wrapper"}),a("div",{className:"container"},a("div",{className:"page-header"},a("h1",{},a("img",{src:"/static/res/rv.svg",
style:{height:"1em",position:"relative",top:"-0.2em",margin:"0 0.3em 0 0"}}),"RVHS Science Lab Undertaking \u2014 For Teachers")),a("p",{},"You are logged in as "+K+". ",u?"You are an administrator. ":null,a("a",{href:"/auth/logout"},"Click here to logout. ")),a("div",{role:"tabpanel"},a("ul",{className:"nav nav-tabs"},c)),a("div",{id:"main-content"})))},componentDidMount:function(){var b=f.location.pathname;return"undefined"===typeof f.EventSource?q.render(a(F,{canClose:!0,title:"Browser Unsupported"},
a("p",{},"Your browser is unsupported. Although you may still be able to use this site, it is ",a("b",{},"highly recommended")," that you use a different browser, such as Google Chrome 9 or higher, Mozilla Firefox 6 or higher, or Apple Safari 5 or higher. Internet Explorer is known to behave inconsistently and therefore should not be used.")),r()):q.render(a(t[b].component,{}),m("#main-content").get(0))}},{render:function(){return!1}},d.invert({Page:"displayName"})));return q.render(a(l,{}),n.getElementById("body"))})})(window,
document,React,ReactDOM,$,_);
