...
$jscomp.makeIterator=function(f){$jscomp.initSymbolIterator();if(f[$jscomp.global.Symbol.iterator])return f[$jscomp.global.Symbol.iterator]();if(!(f instanceof Array||"string"==typeof f||f instanceof String))throw new TypeError(f+" is not iterable");var n=0;return{next:function(){return n==f.length?{done:!0}:{done:!1,value:f[n++]}}}};$jscomp.arrayFromIterator=function(f){for(var n,r=[];!(n=f.next()).done;)r.push(n.value);return r};
$jscomp.arrayFromIterable=function(f){return f instanceof Array?f:$jscomp.arrayFromIterator($jscomp.makeIterator(f))};$jscomp.arrayFromArguments=function(f){for(var n=[],r=0;r<f.length;r++)n.push(f[r]);return n};
$jscomp.inherits=function(f,n){function r(){}r.prototype=n.prototype;f.prototype=new r;f.prototype.constructor=f;for(var p in n)if($jscomp.global.Object.defineProperties){var m=$jscomp.global.Object.getOwnPropertyDescriptor(n,p);void 0!==m&&$jscomp.global.Object.defineProperty(f,p,m)}else f[p]=n[p]};
(function(f,n,r,p,m,d){m(function(){var a=r.createElement,l=r.createClass,q=r.Component,e=r.PropTypes,k=d.map,N=m("#meta-user").attr("value"),x=function(){var a=m("#meta-priv").attr("value");return"PrivAdmin"===a||"PrivOperator"===a}(),G=function(a){var c=("https:"===f.location.protocol?"wss://":"ws://")+f.location.host+a,g=null,h=null,d=null,e=function(){2E3<Date.now()-d?(d=Date.now(),g=new f.WebSocket(c),g.onmessage=h,g.onerror=function(){e()},g.onclose=function(a){e()}):f.setTimeout(e,Date.now()-
d)};return{registerCallback:function(a){g||e();var b=function(b){return a(JSON.parse(b.data))};h=g.onmessage=b},pathname:function(){return a},close:function(){g.onmessage=function(){};g.onerror=function(){};g.onclose=function(){};h=null;g.close()}}},H=function(a){var c="//"+f.location.host+a,g=null,h=null,d=function(){g=new f.EventSource(c);g.onmessage=h;g.onerror=function(){};g.onclose=function(){}};return{registerCallback:function(a){g||d();var b=function(b){return a(JSON.parse(b.data))};h=g.onmessage=
b},pathname:function(){return a},close:function(){h=null;g.close()}}},I=function(a){var c="//"+f.location.host+a,g=null,h=null,d=function(){m.ajax({url:c,success:function(a){g&&g(a);h=f.setTimeout(d,3E3)}})};d();return{registerCallback:function(a){g=a},pathname:function(){return a},close:function(){h&&f.clearTimeout(h);h=null}}},y=f.EventSource?H:f.WebSocket?G:I,A=function(a){q.call(this,a)};$jscomp.inherits(A,q);A.prototype.render=function(){var b=this,c=v[f.location.pathname].dataSpec,g=null!==
...
a("button",{type:"button",className:"btn btn-default btn-xs",title:"Remove",onClick:function(){return p.render(a(O,{auxiliary:b.props.auxiliary,entity:b.props.entity}),t())}},a("span",{className:"glyphicon glyphicon-trash","aria-hidden":"true"}))));return a("tr",{},g,k(c.columns,function(c,h){return a("td",{key:h},c[1].apply(b.props.auxiliary,[b.props.entity[c[0]],b.props.entity]))}),x?h:null)};A.propTypes={firstRowSpan:e.number.isRequired,entity:e.object.isRequired,entityEditor:e.any.isRequired,
auxiliary:e.object};var C=function(a){q.call(this,a)};$jscomp.inherits(C,q);C.prototype.render=function(){var b=this;return a("tbody",{},k(this.props.entities,function(c,g,h){return a(A,{key:c.id,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,entity:c,firstRowSpan:g?0:h.length})}))};C.propTypes={entities:e.array.isRequired,entityEditor:e.any.isRequired,auxiliary:e.object};var u=function(a){q.call(this,a);this.state={tableData:{data:[]}}};$jscomp.inherits(u,q);u.prototype.registerCallback=
...
g=(this.props.customFilter||d.identity)(this.state.tableData.data),h=function(){if(c.categoryColumn){var h=c.categoryColumn[0],e=c.columns[0][0],f=k(d.sortBy(k(d.groupBy(g,h),function(a,b){return{k:b,v:d.sortBy(a,e)}}),"k"),function(a){return a.v});return k(f,function(c){return a(C,{entities:c,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,key:c[0][h]})})}f=d.sortBy(g,c.columns[0][0]);return a("tbody",{},k(f,function(c){return a(A,{firstRowSpan:1,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,
entity:c,key:c.id})}))}(),e=function(a){return"[object Function]"===Object.prototype.toString.call(a)?a(g):a},l=function(){var b=a("span",{className:"glyphicon glyphicon-trash","aria-hidden":"true"});return a("th",{className:"text-right"},a("button",{type:"button",className:"btn btn-danger btn-xs",onClick:function(){var b=k(g,"id").join(","),h=g.length,d=1===h?"1 "+c.humanNameInSentence:h+" "+c.humanNamePluralInSentence,e=a(w,{canClose:!0,title:"Nothing Currently Shown",buttons:a("button",{type:"button",
className:"btn btn-default","data-dismiss":"modal"},"Close"),children:a("p",{},"Nothing is currently shown on screen.")}),d=a(B,{title:"Deleting All "+c.humanNamePlural+" Currently Shown",actionButtonLabel:"Yes, Delete All Currently Shown",actionButtonStyle:"danger",ajaxParam:function(){return{url:"/api/"+c.machineName,type:"DELETE",data:{ids:b}}}},a("p",{},"Are you sure you want to delete all ",c.humanNamePluralInSentence," currently shown on screen? This will delete ",d,". "));p.render(h?d:e,t())},
title:"Click to delete all "+c.humanNamePluralInSentence+" currently shown."},b,a("span",{className:"presentation-text","data-text":" Remove These"})))}(),m=k((null===c.categoryColumn?[]:[e(c.categoryColumn[2])]).concat(k(c.columns,function(a){return e(a[2])})),function(b,c){return a("th",{key:c},b)});return a("div",{className:"table-responsive"},a("table",{className:"table"},a("thead",{},a("tr",{},m,x?l:null)),h))};u.propTypes={conn:e.object.isRequired,entityEditor:e.any.isRequired,auxiliary:e.object,
customFilter:e.func};var w=function(a){q.call(this,a)};$jscomp.inherits(w,q);w.prototype.componentDidMount=function(){m(this.refs.modal).on("hidden.bs.modal",function(){p.unmountComponentAtNode(t())}).modal({keyboard:!1,backdrop:"static"})};w.prototype.render=function(){var b=a("div",{className:"modal-header"},this.props.canClose?a("button",{type:"button",className:"close",id:"modalClose","data-dismiss":"modal"},a("span",{"aria-hidden":"true"},"\u00d7"),a("span",{className:"sr-only"},"Close")):"",
a("h4",{className:"modal-title"},this.props.title)),c=this.props.buttons?a("div",{className:"modal-footer"},this.props.buttons):"";return a("div",{ref:"modal",id:"modal",className:"modal fade"},a("div",{className:"modal-dialog"},a("div",{className:"modal-content"},b,a("div",{className:"modal-body"},this.props.children),c)))};w.propTypes={canClose:e.bool.isRequired,title:e.node.isRequired,buttons:e.node,children:e.node.isRequired};var t=function(){return m("#modal-wrapper").get(0)},J=function(){return m("#modal").modal("hide")},
...
G=l(d.defaults({propTypes:{entity:e.object},render:function(){return a(D,{entity:this.props.entity,entityTypeHumanName:"CCA",entityTypeMachineName:"ccas"},a("div",{className:"form-group"},a("label",{htmlFor:"name"},"CCA Name"),a("input",{type:"text",className:"form-control",name:"name",placeholder:"e.g. Infocomm Club",defaultValue:this.props.entity?this.props.entity.name:""})),a("div",{className:"form-group"},a("label",{htmlFor:"category"},"CCA Category"),a("input",{type:"text",className:"form-control",
...
{render:function(){return!1}},d.invert({SubjectEditor:"displayName"}))),K=function(a){q.call(this,a)};$jscomp.inherits(K,q);K.prototype.render=function(){var b=this,c=v[f.location.pathname].dataSpec;return a(B,{actionButtonStyle:"primary",actionButtonLabel:"Upload",title:"Add "+c.humanNamePlural+" via Uploading CSV/TSV/TXT File",ajaxParam:function(){return{url:"/api/"+c.machineName+"/csv",type:"POST",data:new f.FormData(b.refs.uploaderForm),contentType:!1,processData:!1}}},a("form",{id:"uploaderForm",
...
{render:function(){return!1}},d.invert({StudentEditor:"displayName"}))),O=l(d.defaults({propTypes:{entity:e.object.isRequired},render:function(){var b=v[f.location.pathname].dataSpec,c=b.humanName,g="/api/"+b.machineName+"/"+this.props.entity.id;return a(B,{title:"Delete "+c,actionButtonLabel:"Delete",actionButtonStyle:"danger",ajaxParam:function(){return{url:g,type:"DELETE"}}},a("p",{},"Are you sure you want to delete the ",c," \u201c",this.props.entity.name,"\u201d from the database?"))}},{render:function(){return!1}},
d.invert({DeleteConfirmation:"displayName"}))),R=l(d.defaults({render:function(){return a("div",{className:"row"},a("div",{className:"col-sm-11 col-md-8 col-lg-7"},a("h2",{},"Welcome"),a("p",{},"Welcome to the admin console for RVHS Science Lab Undertaking Project. Click Manage Students from the tab above to view information about students.",x?" As an administrator, you can also manage other things from the above tabs.":null)))}},{render:function(){return!1}},d.invert({AdminHomeR:"displayName"}))),
L=function(a){q.call(this,a)};$jscomp.inherits(L,q);L.prototype.render=function(){return a("div",{className:"row"},a("div",{className:"col-sm-11 col-md-8 col-lg-7"},a("h2",{},"System Tools"),a("p",{},"The special tools on this page are useful at the beginning or end of student info collection."),a("h3",{},"Resetting Database"),a("p",{},"Use the button below to delete ",a("strong",{style:{textTransform:"uppercase"}},"everything")," from the database and reset all settings, except that it does not remove the current admin user. This is because deleting the current admin user would have prevented you from logging in again."),
a("p",{},a("button",{type:"button",className:"btn btn-danger",role:"button",onClick:function(){p.render(a(B,{title:"Reset The Entire Database",actionButtonLabel:"Yes, Reset The Database",actionButtonStyle:"danger",ajaxParam:function(){return{url:"/api",type:"DELETE"}}},a("p",{},"Are you sure you want to reset the entire database? This operation is highly destructive.")),t())}},"Delete ",a("strong",{style:{textTransform:"uppercase"}},"everything")))))};var E=l(d.defaults({propTypes:{customButtons:e.node,
wsUrl:e.string,auxiliary:e.object,customFilter:e.func},getInitialState:function(){var a=v[f.location.pathname].dataSpec.machineName;return{conn:y(this.props.wsUrl||"/api/"+a)}},componentWillReceiveProps:function(a){a.wsUrl!==this.props.wsUrl?(this.state.conn.close(),a=this.setState({conn:y(a.wsUrl)})):a=void 0;return a},render:function(){var b=this,c=v[f.location.pathname].dataSpec,g=c.humanNamePlural,h=c.editor,c=function(){return p.render(a(h,{auxiliary:b.props.auxiliary}),t())};return a("div",
{},x?a("div",{className:"pull-right btn-group",role:"toolbar","aria-label":"Action Buttons"},this.props.customButtons?this.props.customButtons:null,a("button",{type:"button",className:"btn btn-default",onClick:function(){return p.render(a(K,{}),t())}},"Add New (CSV/TSV/TXT File)"),a("button",{type:"button",className:"btn btn-default",onClick:c},"Add New")):null,a("h2",{},"View "+g),this.props.children,a(u,{conn:this.state.conn,entityEditor:h,auxiliary:this.props.auxiliary,customFilter:this.props.customFilter}))},
shouldComponentUpdate:function(a){return!d.isEqual(this.props,a)}},{render:function(){return!1}},d.invert({EntityPage:"displayName"}))),S=l(d.defaults({render:function(){return a(E,{})}},{render:function(){return!1}},d.invert({AdminCcasR:"displayName"}))),T=l(d.defaults({render:function(){var b=a("button",{onClick:function(){return p.render(a(P,{}),t())},type:"button",className:"btn btn-default"},"Test Decode");return a(E,{customButtons:b})}},{render:function(){return!1}},d.invert({AdminSubjectsR:"displayName"}))),
U=l(d.defaults({render:function(){return a(E,{})}},{render:function(){return!1}},d.invert({AdminTeachersR:"displayName"}))),z=function(a){var c=this;a=y("/api/ccas");var g=y("/api/teachers"),h=y("/api/subjects"),d=y("/api/classes");a.registerCallback(function(a){c.setState({ccaInfo:a});c.reserializeForm()});g.registerCallback(function(a){c.setState({teacherInfo:a});c.reserializeForm()});h.registerCallback(function(a){c.setState({subjectInfo:a});c.reserializeForm()});d.registerCallback(function(a){c.setState({classInfo:a});
c.reserializeForm()});d={data:[]};this.state={queryString:"searchby=none",selected:"class",hideWithoutWitness:!0,ccaConn:a,teacherConn:g,subjectConn:h,ccaInfo:d,teacherInfo:d,subjectInfo:d,classInfo:d}};$jscomp.inherits(z,q);z.prototype.reserializeForm=function(){var a=m(this.refs.searchbyForm).serialize();"searchby=class"===a||"searchby=level"===a?this.setState({queryString:"searchby=none"}):this.setState({queryString:a})};z.prototype.componentDidUpdate=function(a,c){c.selected!==this.state.selected&&
this.reserializeForm()};z.prototype.componentWillUnmount=function(){this.state.ccaConn.close();this.state.teacherConn.close();this.state.subjectConn.close();this.state.classConn.close()};z.prototype.render=function(){var b=this,c=function(a){a.target.checked&&b.setState({selected:a.target.value})},g={teacherInfo:this.state.teacherInfo,ccaInfo:this.state.ccaInfo,subjectInfo:this.state.subjectInfo,classInfo:this.state.classInfo};return a("div",{},a("div",{className:"row"},a("h4",{className:"col-sm-offset-3 col-md-offset-3 col-lg-offset-3  col-sm-9 col-md-7 col-lg-6 "},
...
a("div",{className:"checkbox"},a("label",{},a("input",{type:"checkbox",defaultChecked:!0,onChange:function(a){b.setState({hideWithoutWitness:a.target.checked})}})," Hide Students Without Witness"))))),a("div",{className:"row"},a(E,{wsUrl:"/api/students?"+this.state.queryString,auxiliary:g,customFilter:function(a){return b.state.hideWithoutWitness?d.filter(a,function(a){return a.witnesser}):a}})))};var F=function(a,c){return d.find(a.data,function(a){return c===a.id})||"??"},V=l(d.defaults({propTypes:{sub:e.object.isRequired,
...
{render:function(){return!1}},d.invert({SubmissionCompleteModal:"displayName"}))),v={"/admin":{pageName:"Home",onlyAdmin:!1,component:R,dataSpec:null},"/admin/ccas":{pageName:"Manage CCAs",onlyAdmin:!1,component:S,dataSpec:{humanName:"CCA",humanNamePlural:"CCAs",humanNameInSentence:"CCA",humanNamePluralInSentence:"CCAs",machineName:"ccas",editor:G,categoryColumn:["category",d.identity,"CCA Category"],columns:[["name",d.identity,"CCA Name"]]}},"/admin/subjects":{pageName:"Manage Subjects",onlyAdmin:!1,
component:T,dataSpec:{humanName:"Subject",humanNamePlural:"Subjects",humanNameInSentence:"subject",humanNamePluralInSentence:"subjects",machineName:"subjects",editor:H,categoryColumn:["level",function(a){return k(a,function(a){return"Year "+a}).join(", ")},"Applies To"],columns:[["name",d.identity,"Subject Name"],["code",function(b){return b?a("code",{},b):a("i",{},"(None; Compulsory Subject)")},"Subject Code"],["is_science",function(a){return a?"Yes":"No"},"Science Subject?"]]}},"/admin/teachers":{pageName:"Manage Teachers",
onlyAdmin:!0,component:U,dataSpec:{humanName:"Teacher",humanNamePlural:"Teachers",humanNameInSentence:"teacher",humanNamePluralInSentence:"teachers",machineName:"teachers",editor:I,categoryColumn:null,columns:[["name",d.identity,"Name"],["unit",d.identity,"Unit"],["email",d.identity,"Email Address"],["is_admin",function(a){return a?"Yes":"No"},"Administrator?"],["witness_name",d.identity,"Witness Name"]]}},"/admin/students":{pageName:"Manage Students",onlyAdmin:!1,component:z,dataSpec:{humanName:"Student",
humanNamePlural:"Students",humanNameInSentence:"student",humanNamePluralInSentence:"students",machineName:"students",editor:Q,categoryColumn:["class",d.identity,"Class"],columns:[["index_number",d.identity,"Index #"],["name",d.identity,"Name"],["chinese_name",d.identity,"Chinese"],["nric",function(a){return a.slice(-5)},"ID"],["subject_combi",function(b){var c=this,d=k(b,function(a){return F(c.subjectInfo,a).code}).join(", ");b=k(b,function(a){return F(c.subjectInfo,a).name}).join(", ");return d?
...
c,a("span",{className:"presentation-text","data-text":" Lock These"})))}]]}},"/admin/special":{pageName:"System Tools",onlyAdmin:!0,component:L,dataSpec:null}},l=function(a){q.call(this,a)};$jscomp.inherits(l,q);l.prototype.render=function(){var b=f.location.pathname,c=k(v,function(c,d){var e=a("li",{key:d,role:"presentation",className:d===b?"active":""},a("a",{href:d===b?"#":d},c.pageName));return!c.onlyAdmin||x?e:null});return a("div",{id:"content-wrapper"},a("div",{id:"popover-wrapper"}),a("div",
{id:"modal-wrapper"}),a("div",{className:"container"},a("div",{className:"page-header"},a("h1",{},a("img",{src:"/static/res/rv.svg",style:{height:"1em",position:"relative",top:"-0.2em",margin:"0 0.3em 0 0"}}),"RVHS Science Lab Undertaking \u2014 For Teachers")),a("p",{},"You are logged in as ",N,". ",x?"You are an administrator. ":"You are not an administrator, and many features and pages have been hidden.",a("a",{href:"/auth/logout"},"Click here to logout. ")),a("div",{role:"tabpanel"},a("ul",{className:"nav nav-tabs"},
c)),a("div",{id:"main-content"},a(v[b].component,{}))))};l.prototype.componentDidMount=function(){f.EventSource||p.render(a(w,{canClose:!0,title:"Browser Unsupported"},a("p",{},"Your browser is unsupported. Although you may still be able to use this site, it is ",a("b",{},"highly recommended")," that you use a different browser, such as Google Chrome 9 or higher, Mozilla Firefox 6 or higher, or Apple Safari 5 or higher. Internet Explorer is known to behave inconsistently and therefore should not be used.")),
t())};return p.render(a(l,{}),n.getElementById("body"))})})(window,document,React,ReactDOM,$,_);
