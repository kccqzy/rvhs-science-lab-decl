'use strict';(function(l,G,u,n,m,c){m(function(){var a=u.createElement,f=u.createClass,d=u.PropTypes,g=c.map,H=m("#meta-user").attr("value"),r=m("#meta-priv").attr("value"),z=function(a){var e=("https:"===l.location.protocol?"wss://":"ws://")+l.location.host+a,h=null,c=null,k=null,d=function(){2E3<Date.now()-k?(k=Date.now(),h=new l.WebSocket(e),h.onmessage=c,h.onerror=function(){console.log("WS connection errored. Retrying.");d()},h.onclose=function(a){console.log(a);console.log("WS connection closed without request from client. Retrying.");
d()}):l.setTimeout(d,Date.now()-k)},g=function(){h.onmessage=function(){};h.onerror=function(){};h.onclose=function(){};c=null;h.close()};m(l).on("beforeunload",function(){g()});return{registerCallback:function(a){h||d();var b=function(b){return a(JSON.parse(b.data))};c=h.onmessage=b},pathname:function(){return a},close:g}},A=function(a){var e="//"+l.location.host+a,h=null,c=null;return{registerCallback:function(a){h||(h=new l.EventSource(e),h.onmessage=c);var b=function(b){return a(JSON.parse(b.data))};
c=h.onmessage=b},pathname:function(){return a},close:function(){c=null;h.close()}}},B=function(a){var e="//"+l.location.host+a,h=null,c=null,k=function(){m.ajax({url:e,success:function(a){h&&h(a);c=l.setTimeout(k,3E3)}})};k();return{registerCallback:function(a){h=a},pathname:function(){return a},close:function(){c&&l.clearTimeout(c);c=null}}},t=l.EventSource?A:l.WebSocket?z:B,E=f(c.defaults({propTypes:{firstRowSpan:d.number.isRequired,entity:d.object.isRequired,entityEditor:d.any.isRequired,auxiliary:d.object},
render:function(){var b=this,e=p[l.location.pathname].dataSpec,c=null!==e.categoryColumn&&b.props.firstRowSpan?a("td",{rowSpan:b.props.firstRowSpan},e.categoryColumn[1].apply(b.props.auxiliary,[b.props.entity[e.categoryColumn[0]],b.props.entity])):null,d=function(){return n.render(a(b.props.entityEditor,{auxiliary:b.props.auxiliary,entity:b.props.entity}),q())},k=function(){return n.render(a(J,{auxiliary:b.props.auxiliary,entity:b.props.entity}),q())};return a("tr",{},c,g(e.columns,function(e,c){return a("td",
{key:c},e[1].apply(b.props.auxiliary,[b.props.entity[e[0]],b.props.entity]))}),"PrivAdmin"===r?a("td",{className:"text-right"},a("div",{className:"btn-group",role:"group"},a("button",{type:"button",className:"btn btn-default btn-xs",title:"Edit",onClick:d},a("span",{className:"glyphicon glyphicon-pencil","aria-hidden":"true"})),a("button",{type:"button",className:"btn btn-default btn-xs",title:"Delete",onClick:k},a("span",{className:"glyphicon glyphicon-trash","aria-hidden":"true"})))):null)}},{render:function(){return!1}},
c.invert({EntityRow:"displayName"}))),K=f(c.defaults({propTypes:{entities:d.array.isRequired,entityEditor:d.any.isRequired,auxiliary:d.object},render:function(){var b=this;return a("tbody",{},g(this.props.entities,function(e,c,d){return a(E,{key:e.id,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,entity:e,firstRowSpan:c?0:d.length})}))}},{render:function(){return!1}},c.invert({EntityCategory:"displayName"}))),L=f(c.defaults({propTypes:{conn:d.object.isRequired,entityEditor:d.any.isRequired,
...
this.props.conn.close():void 0},render:function(){var b=this,e=p[l.location.pathname].dataSpec,h=(this.props.customFilter||c.identity)(this.state.tableData.data),d=null===e.categoryColumn?function(){var k=c.sortBy(h,e.columns[0][0]);console.log(b.state.tableData);console.log(h);console.log(k);return a("tbody",{},g(k,function(e){return a(E,{firstRowSpan:1,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,entity:e,key:e.id})}))}():function(){var k=e.categoryColumn[0],d=e.columns[0][0],I=
g(c.sortBy(g(c.groupBy(h,k),function(a,b){return{k:b,v:c.sortBy(a,d)}}),"k"),function(a){return a.v});return g(I,function(e){return a(K,{entities:e,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,key:e[0][k]})})}(),k=function(a){return"[object Function]"===Object.prototype.toString.call(a)?a(h):a},f=g((null===e.categoryColumn?[]:[k(e.categoryColumn[2])]).concat(g(e.columns,function(a){return k(a[2])})),function(b,e){return a("th",{key:e},b)});return a("div",{className:"table-responsive"},
...
")")})))),a("div",{className:"form-group"},a("label",{htmlFor:"subj"},"Subject Combination"),a("div",{className:"checkbox"},this.state.currentLevel?g(c.filter(b.props.auxiliary.subjectInfo.data,function(a){return c.contains(a.level,b.state.currentLevel)&&null!==a.code}),function(e,h){return a("label",{className:"checkbox-inline",key:e.id},a("input",{type:"checkbox",name:"subj",value:1+h,defaultChecked:b.props.entity?c.contains(b.props.entity.subject_combi,e.id):!1}),e.name," (",e.code,")")}):a("p",
...
buttons:c},a("table",{className:"table"},a("tbody",{},a("tr",{},a("th",{},"Email"),a("td",{},this.props.sub.email)),a("tr",{},a("th",{},"Phone Number"),a("td",{},this.props.sub.phone)),a("tr",{},a("th",{},"Date of Submission"),a("td",{},this.props.sub.date)),a("tr",{},a("th",{},"CCAs"),a("td",{},g(this.props.sub.cca,function(a){return y(b.props.ccaInfo,a).name}).join(", ")||"None")),a("tr",{},a("th",{},"Delete Submission"),a("td",{},a("div",{className:"btn-toolbar",role:"toolbar"},a("button",{type:"button",
...
machineName:"ccas",editor:z,categoryColumn:["category",c.identity,"CCA Category"],columns:[["name",c.identity,"CCA Name"]]}},"/admin/subjects":{pageName:"Manage Subjects",onlyAdmin:!0,component:R,dataSpec:{humanName:"Subject",humanNamePlural:"Subjects",machineName:"subjects",editor:A,categoryColumn:["level",function(a){return g(a,function(a){return"Year "+a}).join(", ")},"Applies To"],columns:[["name",c.identity,"Subject Name"],["code",function(b){return b?a("code",{},b):a("i",{},"(None; Compulsory Subject)")},
...
onlyAdmin:!1,component:T,dataSpec:{humanName:"Student",humanNamePlural:"Students",machineName:"students",editor:O,categoryColumn:["class",c.identity,"Class"],columns:[["index_number",c.identity,"Index #"],["name",c.identity,"Name"],["chinese_name",c.identity,"Chinese"],["nric",function(a){return a.slice(-5)},"ID"],["subject_combi",function(b){var c=this,d=g(b,function(a){return y(c.subjectInfo,a).code}).join(", ");b=g(b,function(a){return y(c.subjectInfo,a).name}).join(", ");return d?a("span",{title:b},
...
"aria-hidden":"true"})):"SubmissionCompleted"===b.tag?a("img",{src:"/static/res/loading.gif",width:16,height:16,style:{margin:"0 4px"}}):void 0},"PDF"],["submission",function(b,c){var d=this,f=a("span",{className:"glyphicon glyphicon-lock","aria-hidden":"true"}),g=a("span",{className:"glyphicon glyphicon-ok","aria-hidden":"true"}),l=function(){return m.ajax("/api/students/"+c.id+"/unlock",{type:"POST"})},p=function(){return m.ajax("/api/students/"+c.id+"/lock",{type:"POST"})},r=function(){return n.render(a(U,
{ccaInfo:d.ccaInfo,sub:b,onLockClick:p,onUnlockClick:l}),q())};return a("div",{className:"btn-group",role:"toolbar","aria-label":"Status Buttons"},"SubmissionNotOpen"===b.tag?a("button",{type:"button",className:"btn btn-danger btn-xs",onClick:l,title:"Click to unlock submission."},f,a("span",{className:"presentation-text","data-text":" Locked"})):"SubmissionOpen"===b.tag?a("button",{type:"button",className:"btn btn-primary btn-xs",onClick:p,title:"Click to lock submission."},f,a("span",{className:"presentation-text",
"data-text":" Unlocked"})):"SubmissionCompleted"===b.tag?a("button",{type:"button",className:"btn btn-success btn-xs",onClick:r,title:"Click to view submitted information."},g,a("span",{className:"presentation-text","data-text":" Completed"})):void 0)},function(b){var c=a("span",{className:"glyphicon glyphicon-lock","aria-hidden":"true"});a("span",{className:"glyphicon glyphicon-ok","aria-hidden":"true"});return a("span",{},a("button",{type:"button",className:"btn btn-primary btn-xs",onClick:function(){var a=
