...
{render:function(){return!1}},d.invert({SubjectEditor:"displayName"}))),K=function(a){r.call(this,a)};$jscomp.inherits(K,r);K.prototype.render=function(){var b=this,c=v[e.location.pathname].dataSpec;return a(C,{actionButtonStyle:"primary",actionButtonLabel:"Upload",title:"Add "+c.humanNamePlural+" via Uploading CSV/TSV/TXT File",ajaxParam:function(){return{url:"/api/"+c.machineName+"/csv",type:"POST",data:new e.FormData(b.refs.uploaderForm),contentType:!1,processData:!1}}},a("form",{id:"uploaderForm",
...
E=l(d.defaults({propTypes:{customButtons:f.node,wsUrl:f.string,auxiliary:f.object,customFilter:f.func},getInitialState:function(){var a=v[e.location.pathname].dataSpec.machineName;return{conn:y(this.props.wsUrl||"/api/"+a)}},componentWillReceiveProps:function(a){a.wsUrl!==this.props.wsUrl?(this.state.conn.close(),a=this.setState({conn:y(a.wsUrl)})):a=void 0;return a},render:function(){var b=this,c=v[e.location.pathname].dataSpec,d=c.humanNamePlural,h=c.editor,c=function(){return p.render(a(h,{auxiliary:b.props.auxiliary}),
t())};return a("div",{},x?a("div",{className:"pull-right btn-group",role:"toolbar","aria-label":"Action Buttons"},this.props.customButtons?this.props.customButtons:null,a("button",{type:"button",className:"btn btn-default",onClick:function(){return p.render(a(K,{}),t())}},"Add New (CSV/TSV/TXT File)"),a("button",{type:"button",className:"btn btn-default",onClick:c},"Add New")):null,a("h2",{},"View "+d),this.props.children,a(u,{conn:this.state.conn,entityEditor:h,auxiliary:this.props.auxiliary,customFilter:this.props.customFilter}))},
shouldComponentUpdate:function(a){return!d.isEqual(this.props,a)}},{render:function(){return!1}},d.invert({EntityPage:"displayName"}))),R=l(d.defaults({render:function(){return a(E,{})}},{render:function(){return!1}},d.invert({AdminCcasR:"displayName"}))),S=l(d.defaults({render:function(){var b=a("button",{onClick:function(){return p.render(a(O,{}),t())},type:"button",className:"btn btn-default"},"Test Decode");return a(E,{customButtons:b})}},{render:function(){return!1}},d.invert({AdminSubjectsR:"displayName"}))),
T=l(d.defaults({render:function(){return a(E,{})}},{render:function(){return!1}},d.invert({AdminTeachersR:"displayName"}))),z=function(a){var c=this;a=y("/api/ccas");var d=y("/api/teachers"),h=y("/api/subjects"),e=y("/api/classes");a.registerCallback(function(a){c.setState({ccaInfo:a});c.reserializeForm()});d.registerCallback(function(a){c.setState({teacherInfo:a});c.reserializeForm()});h.registerCallback(function(a){c.setState({subjectInfo:a});c.reserializeForm()});e.registerCallback(function(a){c.setState({classInfo:a});
c.reserializeForm()});e={data:[]};this.state={queryString:"searchby=none",selected:"class",hideWithoutWitness:!0,ccaConn:a,teacherConn:d,subjectConn:h,ccaInfo:e,teacherInfo:e,subjectInfo:e,classInfo:e}};$jscomp.inherits(z,r);z.prototype.reserializeForm=function(){var a=m(this.refs.searchbyForm).serialize();"searchby=class"===a||"searchby=level"===a?this.setState({queryString:"searchby=none"}):this.setState({queryString:a})};z.prototype.componentDidUpdate=function(a,c){c.selected!==this.state.selected&&
...
a("div",{className:"checkbox"},a("label",{},a("input",{type:"checkbox",defaultChecked:!0,onChange:function(a){b.setState({hideWithoutWitness:a.target.checked})}})," Hide Students Without Witness"))))),a("div",{className:"row"},a(E,{wsUrl:"/api/students?"+this.state.queryString,auxiliary:e,customFilter:function(a){return b.state.hideWithoutWitness?d.filter(a,function(a){return a.witnesser}):a}})))};var F=function(a,c){return d.find(a.data,function(a){return c===a.id})||"??"},U=l(d.defaults({propTypes:{sub:f.object.isRequired,
