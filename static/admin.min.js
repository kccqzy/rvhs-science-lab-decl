...
typeof f.EventSource?q.render(a(F,{canClose:!0,title:"Browser Unsupported"},a("p",{},"Your browser is unsupported. Although you may still be able to use this site, it is ",a("b",{},"highly recommended")," that you use a different browser, such as Google Chrome 9 or higher, Mozilla Firefox 6 or higher, or Apple Safari 5 or higher. Internet Explorer is known to behave inconsistently and therefore should not be used.")),r()):q.render(a(t[b].component,{}),m("#main-content").get(0))}},{render:function(){return!1}},
d.invert({Page:"displayName"})));return q.render(a(l,{}),n.getElementById("body"))})})(window,document,React,ReactDOM,$,_);
