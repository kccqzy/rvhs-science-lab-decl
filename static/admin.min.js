...
a("button",{type:"button",className:"btn btn-default btn-xs",title:"Remove",onClick:function(){return p.render(a(N,{auxiliary:b.props.auxiliary,entity:b.props.entity}),t())}},a("span",{className:"glyphicon glyphicon-trash","aria-hidden":"true"}))));return a("tr",{},g,k(c.columns,function(c,g){return a("td",{key:g},c[1].apply(b.props.auxiliary,[b.props.entity[c[0]],b.props.entity]))}),x?h:null)};A.propTypes={firstRowSpan:f.number.isRequired,entity:f.object.isRequired,entityEditor:f.any.isRequired,
auxiliary:f.object};var C=function(a){r.call(this,a)};$jscomp.inherits(C,r);C.prototype.render=function(){var b=this;return a("tbody",{},k(this.props.entities,function(c,g,h){return a(A,{key:c.id,entityEditor:b.props.entityEditor,auxiliary:b.props.auxiliary,entity:c,firstRowSpan:g?0:h.length})}))};C.propTypes={entities:f.array.isRequired,entityEditor:f.any.isRequired,auxiliary:f.object};var u=function(a){r.call(this,a);this.state={tableData:{data:[]}}};$jscomp.inherits(u,r);u.prototype.registerCallback=
...
customFilter:f.func};var w=function(a){r.call(this,a)};$jscomp.inherits(w,r);w.prototype.componentDidMount=function(){m(this.refs.modal).on("hidden.bs.modal",function(){p.unmountComponentAtNode(t())}).modal({keyboard:!1,backdrop:"static"})};w.prototype.render=function(){var b=a("div",{className:"modal-header"},this.props.canClose?a("button",{type:"button",className:"close",id:"modalClose","data-dismiss":"modal"},a("span",{"aria-hidden":"true"},"\u00d7"),a("span",{className:"sr-only"},"Close")):"",
...
E=l(d.defaults({propTypes:{customButtons:f.node,wsUrl:f.string,auxiliary:f.object,customFilter:f.func},getInitialState:function(){var a=v[e.location.pathname].dataSpec.machineName;return{conn:y(this.props.wsUrl||"/api/"+a)}},componentWillReceiveProps:function(a){a.wsUrl!==this.props.wsUrl?(this.state.conn.close(),a=this.setState({conn:y(a.wsUrl)})):a=void 0;return a},render:function(){var b=this,c=v[e.location.pathname].dataSpec,g=c.humanNamePlural,h=c.machineName,d=c.editor,c=function(){return p.render(a(d,
{auxiliary:b.props.auxiliary}),t())},f=function(){return p.render(a(B,{title:"Deleting All "+g,actionButtonLabel:"Yes, Delete All",actionButtonStyle:"danger",ajaxParam:function(){return{url:"/api/"+h,type:"DELETE"}}},a("p",{},"Are you sure you want to delete all ",g," currently stored in the database? ")),t())};return a("div",{},x?a("div",{className:"pull-right btn-group",role:"toolbar","aria-label":"Action Buttons"},this.props.customButtons?this.props.customButtons:null,a("button",{type:"button",
className:"btn btn-default",onClick:function(){return p.render(a(K,{}),t())}},"Add New (CSV/TSV/TXT File)"),a("button",{type:"button",className:"btn btn-default",onClick:c},"Add New"),a("button",{type:"button",className:"btn btn-danger",onClick:f},"Remove ",a("strong",{style:{textTransform:"uppercase"}},"Everything"))):null,a("h2",{},"View "+g),this.props.children,a(u,{conn:this.state.conn,entityEditor:d,auxiliary:this.props.auxiliary,customFilter:this.props.customFilter}))},shouldComponentUpdate:function(a){return!d.isEqual(this.props,
a)}},{render:function(){return!1}},d.invert({EntityPage:"displayName"}))),R=l(d.defaults({render:function(){return a(E,{})}},{render:function(){return!1}},d.invert({AdminCcasR:"displayName"}))),S=l(d.defaults({render:function(){var b=a("button",{onClick:function(){return p.render(a(O,{}),t())},type:"button",className:"btn btn-default"},"Test Decode");return a(E,{customButtons:b})}},{render:function(){return!1}},d.invert({AdminSubjectsR:"displayName"}))),T=l(d.defaults({render:function(){return a(E,
{})}},{render:function(){return!1}},d.invert({AdminTeachersR:"displayName"}))),z=function(a){var c=this;a=y("/api/ccas");var d=y("/api/teachers"),h=y("/api/subjects"),e=y("/api/classes");a.registerCallback(function(a){c.setState({ccaInfo:a});c.reserializeForm()});d.registerCallback(function(a){c.setState({teacherInfo:a});c.reserializeForm()});h.registerCallback(function(a){c.setState({subjectInfo:a});c.reserializeForm()});e.registerCallback(function(a){c.setState({classInfo:a});c.reserializeForm()});
e={data:[]};this.state={queryString:"searchby=none",selected:"class",hideWithoutWitness:!0,ccaConn:a,teacherConn:d,subjectConn:h,ccaInfo:e,teacherInfo:e,subjectInfo:e,classInfo:e}};$jscomp.inherits(z,r);z.prototype.reserializeForm=function(){var a=m(this.refs.searchbyForm).serialize();"searchby=class"===a||"searchby=level"===a?this.setState({queryString:"searchby=none"}):this.setState({queryString:a})};z.prototype.componentDidUpdate=function(a,c){c.selected!==this.state.selected&&this.reserializeForm()};
...
a("div",{className:"checkbox"},a("label",{},a("input",{type:"checkbox",defaultChecked:!0,onChange:function(a){b.setState({hideWithoutWitness:a.target.checked})}})," Hide Students Without Witness"))))),a("div",{className:"row"},a(E,{wsUrl:"/api/students?"+this.state.queryString,auxiliary:g,customFilter:function(a){return b.state.hideWithoutWitness?d.filter(a,function(a){return a.witnesser}):a}})))};var F=function(a,c){return d.find(a.data,function(a){return c===a.id})||"??"},U=l(d.defaults({propTypes:{sub:f.object.isRequired,
...
{render:function(){return!1}},d.invert({SubmissionCompleteModal:"displayName"}))),v={"/admin":{pageName:"Home",onlyAdmin:!1,component:Q,dataSpec:null},"/admin/ccas":{pageName:"Manage CCAs",onlyAdmin:!1,component:R,dataSpec:{humanName:"CCA",humanNamePlural:"CCAs",humanNameInSentence:"CCA",humanNamePluralInSentence:"CCAs",machineName:"ccas",editor:G,categoryColumn:["category",d.identity,"CCA Category"],columns:[["name",d.identity,"CCA Name"]]}},"/admin/subjects":{pageName:"Manage Subjects",onlyAdmin:!1,
component:S,dataSpec:{humanName:"Subject",humanNamePlural:"Subjects",humanNameInSentence:"subject",humanNamePluralInSentence:"subjects",machineName:"subjects",editor:H,categoryColumn:["level",function(a){return k(a,function(a){return"Year "+a}).join(", ")},"Applies To"],columns:[["name",d.identity,"Subject Name"],["code",function(b){return b?a("code",{},b):a("i",{},"(None; Compulsory Subject)")},"Subject Code"],["is_science",function(a){return a?"Yes":"No"},"Science Subject?"]]}},"/admin/teachers":{pageName:"Manage Teachers",
onlyAdmin:!0,component:T,dataSpec:{humanName:"Teacher",humanNamePlural:"Teachers",humanNameInSentence:"teacher",humanNamePluralInSentence:"teachers",machineName:"teachers",editor:I,categoryColumn:null,columns:[["name",d.identity,"Name"],["unit",d.identity,"Unit"],["email",d.identity,"Email Address"],["is_admin",function(a){return a?"Yes":"No"},"Administrator?"],["witness_name",d.identity,"Witness Name"]]}},"/admin/students":{pageName:"Manage Students",onlyAdmin:!1,component:z,dataSpec:{humanName:"Student",
...
c,a("span",{className:"presentation-text","data-text":" Lock These"})))}]]}}},l=l(d.defaults({render:function(){var b=e.location.pathname,c=k(v,function(c,d){var e=a("li",{key:d,role:"presentation",className:d===b?"active":""},a("a",{href:d===b?"#":d},c.pageName));return c.onlyAdmin?x?e:null:e});return a("div",{id:"content-wrapper"},a("div",{id:"popover-wrapper"}),a("div",{id:"modal-wrapper"}),a("div",{className:"container"},a("div",{className:"page-header"},a("h1",{},a("img",{src:"/static/res/rv.svg",
style:{height:"1em",position:"relative",top:"-0.2em",margin:"0 0.3em 0 0"}}),"RVHS Science Lab Undertaking \u2014 For Teachers")),a("p",{},"You are logged in as "+M+". ",x?"You are an administrator. ":"You are not an administrator, and many features and pages have been hidden.",a("a",{href:"/auth/logout"},"Click here to logout. ")),a("div",{role:"tabpanel"},a("ul",{className:"nav nav-tabs"},c)),a("div",{id:"main-content"})))},componentDidMount:function(){var b=e.location.pathname;return"undefined"===
typeof e.EventSource?p.render(a(w,{canClose:!0,title:"Browser Unsupported"},a("p",{},"Your browser is unsupported. Although you may still be able to use this site, it is ",a("b",{},"highly recommended")," that you use a different browser, such as Google Chrome 9 or higher, Mozilla Firefox 6 or higher, or Apple Safari 5 or higher. Internet Explorer is known to behave inconsistently and therefore should not be used.")),t()):p.render(a(v[b].component,{}),m("#main-content").get(0))}},{render:function(){return!1}},
