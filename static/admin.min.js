...
e={data:[]};this.state={queryString:"searchby=none",selected:"class",hideWithoutWitness:!0,ccaConn:a,teacherConn:d,subjectConn:h,ccaInfo:e,teacherInfo:e,subjectInfo:e,classInfo:e}};$jscomp.inherits(w,B);w.prototype.reserializeForm=function(){var a=m(this.refs.searchbyForm).serialize();"searchby=class"===a||"searchby=level"===a?this.setState({queryString:"searchby=none"}):this.setState({queryString:a})};w.prototype.componentDidUpdate=function(a,c){c.selected!==this.state.selected&&this.reserializeForm()};
